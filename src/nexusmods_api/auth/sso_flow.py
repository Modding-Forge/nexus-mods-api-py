...
class SSOFlow:
        ...
        *,
        ...
        try:
            with connect(
                ...
                registration: str | bytes = connection.recv(
                    timeout=self.__config.connection_timeout_seconds,
                )
    ...
    def __parse_value(
        ...
        """Validates one structured SSO v2 response value.
    ...
    def __parse_key(cls, message: str | bytes) -> ApiKeyAuth:
        """Validates the structured SSO v2 API-key response.
