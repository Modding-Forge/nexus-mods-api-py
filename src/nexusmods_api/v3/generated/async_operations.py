...
class GeneratedAsyncOperations:
...
ddModChangelogEntries
        ...
        return await self._request_generated(
...
ation/createCollection
        ...
        return await self._request_generated(
            "createCollection", {}, query=query, body=body
        )
...
ion/createModFile
        ...
        return await self._request_generated("createModFile", {}, query=query, body=body)
...
n/createUpload
        ...
        return await self._request_generated("createUpload", {}, query=query, body=body)
...
n/finaliseUpload
        ...
        return await self._request_generated("finaliseUpload", {"id": id}, query=query)
...
etModFile
        ...
        return await self._request_generated("getModFile", {"id": id}, query=query)
...
etModFileVersion
        ...
        return await self._request_generated("getModFileVersion", {"id": id}, query=query)
...
etModFileVersions
        ...
        return await self._request_generated(
            "getModFileVersions", {"id": id}, query=query
        )
...
etModFiles
        ...
        return await self._request_generated("getModFiles", {"id": id}, query=query)
...
etModsBatch
        ...
        return await self._request_generated("getModsBatch", {}, query=query, body=body)
...
n/getUpload
        ...
        return await self._request_generated("getUpload", {"id": id}, query=query)
...
oveModFileVersions
        ...
        return await self._request_generated(
            "moveModFileVersions", {}, query=query, body=body
        )
