...
class CollectionManifestModSource(NexusModel):
    ...
    """The identifier of the mod file version associated with the mod in this collection\
 manifest.
    """
    ...
    """The embedded UpdatePolicy data for this CollectionManifestModSource value.
    """
